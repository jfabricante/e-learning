				...
				<div class="m-portlet__body">
					<div class="m-widget19">
						<div class="m-widget19__pic m-portlet-fit--top m-portlet-fit--sides" style="min-height-: 286px">
							<img src="{{ asset('metronic_5.05/assets/app/media/img//blog/blog1.jpg') }}" alt="">
						...
						<div class="m-widget19__content">
							<div class="m-widget19__header">
								<div class="m-widget19__user-img">
									<img class="m-widget19__img" src="{{ asset('metronic_5.05/assets/app/media/img//users/user1.jpg') }}" alt="">
								</div>
				...
				<div class="m-portlet__body">
					<div class="m-widget3">
						<div class="m-widget3__item">
							<div class="m-widget3__header">
								<div class="m-widget3__user-img">
									<img class="m-widget3__img" src="{{ asset('metronic_5.05/assets/app/media/img/users/user1.jpg') }}" alt="">
								</div>
						...
						<div class="m-widget3__item">
							<div class="m-widget3__header">
								<div class="m-widget3__user-img">
									<img class="m-widget3__img" src="{{ asset('metronic_5.05/assets/app/media/img/users/user4.jpg') }}" alt="">
								</div>
								<div class="m-widget3__info">
									<span class="m-widget3__username">
										Lebron King James
						...
						<div class="m-widget3__item">
							<div class="m-widget3__header">
								<div class="m-widget3__user-img">
									<img class="m-widget3__img" src="{{ asset('metronic_5.05/assets/app/media/img/users/user5.jpg') }}" alt="">
								</div>
								<div class="m-widget3__info">
									<span class="m-widget3__username">
										Deb Gibson
			...
			<div class="m-portlet m-portlet--full-height m-portlet--fit ">
				...
				<div class="m-portlet__body">
					...
					<div class="m-widget4 m-widget4--chart-bottom" style="min-height: 480px">
						...
						<div class="m-widget4__item">
							<div class="m-widget4__img m-widget4__img--logo">
								<img src="{{ asset('metronic_5.05/assets/app/media/img/client-logos/logo4.png') }}" alt="">
							</div>
							<div class="m-widget4__info">
								<span class="m-widget4__title">
									Starbucks
							...
							<div class="m-widget5">
								<div class="m-widget5__item">
									<div class="m-widget5__pic">
										<img class="m-widget7__img" src="{{ asset('metronic_5.05/assets/app/media/img//products/product6.jpg') }}" alt="">
									</div>
								...
								<div class="m-widget5__item">
									<div class="m-widget5__pic">
										<img class="m-widget7__img" src="{{ asset('metronic_5.05/assets/app/media/img/products/product10.jpg') }}" alt="">
									</div>
									<div class="m-widget5__content">
										<h4 class="m-widget5__title">
											Branding Mockup
								...
								<div class="m-widget5__item">
									<div class="m-widget5__pic">
										<img class="m-widget7__img" src="{{ asset('metronic_5.05/assets/app/media/img//products/product11.jpg') }}" alt="">
									</div>
									<div class="m-widget5__content">
										<h4 class="m-widget5__title">
											Awesome Mobile App
			...
			<div class="m-portlet m-portlet--bordered-semi m-portlet--full-height ">
				...
				<div class="m-portlet__body">
					<div class="m-widget4">
						<div class="m-widget4__item">
							<div class="m-widget4__img m-widget4__img--logo">
								<img src="{{ asset('metronic_5.05/assets/app/media/img/client-logos/logo5.png') }}" alt="">
							</div>
							<div class="m-widget4__info">
								<span class="m-widget4__title">
									Trump Themes
